##########################################################
# Summarization and Visualization of Sliding 
...
## results path
input_path <- "/n/holystore01/LABS/xlin/Lab/xihao_zilin/TOPMed_LDL/Sliding_Window/Results/"
output_path <- input_path

## results name
sliding_window_results_name <- "results_sliding_window"
...
Sliding_Window_Results_Summary(agds_dir=agds_dir,jobs_num=jobs_num,input_path=input_path,output_path=output_path,
sliding_window_results_name=sliding_window_results_name,obj_nullmodel=obj_nullmodel,known_loci=known_loci,
method_cond=method_cond,geno_missing_imputation=geno_missing_imputation,variant_type=variant_type,
