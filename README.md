...
* `STAARpipeline_Gene_Centric_Coding_Long_Masks.r` performs gene-centric coding analysis for some specfic long masks, and might require much larger memory compared to `STAARpipeline_Gene_Centric_Coding.r`. There are 2 jobs using this script.
...
* `STAARpipeline_Gene_Centric_Noncoding_Long_Masks.r` performs gene-centric noncoding analysis for some specfic long masks, and might require much larger memory compared to `STAARpipeline_Gene_Centric_Noncoding.r`. There are 8 jobs using this script.  <br>
...
* `STAARpipeline_Gene_Centric_ncRNA_Long_Masks.r` performs gene-centric noncoding analysis for some specfic long masks, and might require much larger memory compared to `STAARpipeline_Gene_Centric_ncRNA.r`. There is 1 job using this script. 
#### Input: aGDS files and the STAAR null model. For more details, please see the R scripts.
